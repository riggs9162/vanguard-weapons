...
SWEP.Primary.RPM = nil -- Rounds per minute, this is used instead of delay if it's set
SWEP.Primary.Sequence = ACT_VM_PRIMARYATTACK -- The shoot animation
SWEP.Primary.SequenceIronSights = nil -- The shoot animation when iron sighting
...
SWEP.Reloading.SequenceIronSights = nil -- The reload animation when iron sighting
